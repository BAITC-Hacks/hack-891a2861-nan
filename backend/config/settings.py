...
DEMO_MODE = env_bool("DJANGO_DEMO_MODE", default=DEBUG)
...
CORS_ALLOW_HEADERS = (*default_headers, "x-demo-role", "x-employee-id", "idempotency-key")

REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "apps.accounts.authentication.SignedTokenAuthentication",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Explainable employee development recommendations and HR analytics.",
    "VERSION": "1.0.0",
